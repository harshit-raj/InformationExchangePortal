		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="#">Flagged Question</a></li>
				</ul>
						...
						<c:forEach items="${ques}" var="quest">
							<div class="well well-lg">
								...
								<p style="color: #A9A9A9">
									by <a href="/asqa/viewProfile/${usr.userId}">${quest.user.firstName}
										${quest.user.lastName}</a>
								</p>
								<hr>

								<a href="ques/viewQuest/${quest.questionId}"><button
										type="button" class="btn btn-default">View</button></a> 
									
										<a href="/asqa/moderate/unflag/${quest.questionId}" style="float: right;">
										<button type="button" class="btn btn-default">
										<span class="glyphicon glyphicon-flag"></span>
									</button></a> 
									
									<a href="/asqa/ques/delQues/${quest.questionId}"
									style="float: right;"><button type="button" 
