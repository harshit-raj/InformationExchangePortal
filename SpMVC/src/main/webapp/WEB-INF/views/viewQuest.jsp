...
<script
  ...
  <li class="active"><a href="#">Question Asked</a></li>
						...
						<table>
							...
							<c:forEach items="${question}" var ="quest" >
								<div class="well well-lg">
									...
									<a href = "/asqa/viewProfile/${quest.user.userId}"><p style="color:#A9A9A9">by ${quest.user.firstName} ${quest.user.lastName}</p></a>
									<hr>
									
									<a href="ques/viewQuest/${quest.questionId}"><button type="button" class="btn btn-default">View Detail</button></a>
									
									<!-- <a href="ques/viewQuest/${quest.questionId}" style="float: right;"><button type="button" class="btn btn-danger">Delete</button></a> -->
